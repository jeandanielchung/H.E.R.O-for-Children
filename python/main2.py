...
#TODO: update error handling w/ db
...
#TODO: when making a new person, check if one already exists
#TODO: check error stuff
...
#******************************************************************************************************************************************************
    ...
    def SearchResultsPage(self):
        ...
        #TODO: pass in ID when search implemented
...
#******************************************************************************************************************************************************
    ...
    def backFirstProfilePage(self):
        if self.PrevPage is 'SearchResultsPage' or 'SecondChildProfilePage':
